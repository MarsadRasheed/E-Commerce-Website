      ...
      <nav class="navbar navbar-light bg-light navbar-expand-lg "> 
        ...
        <div >
          <ul id="current" class="nav justify-content-end">
            ...
            <li class="active" class="nav-item" style="padding-right: 60px;"> <a  class="nav-link" href=""><i class="fa fa-heart"  ></i> </a> </li>
          </ul>
        </div>
      </nav>
    </div>
                    ...
                    ?>
                          <form method="POST">
                            <tr>
                                ...
                                <input type="hidden" name="hidden_image" value="<?php echo $data["img_dir"] ?>" >
                                <input type="hidden" name="quantity" value="1">

                                <td class="pt-5" width="15%"> <?php echo "$ ".$data["price"]; ?></td>
                                <td class="pt-5" width="15%"><button formaction="AddToCart.php" type="submit" type="button" class="btn btn-outline-info">Add To Cart</button> </td>
                                <td class="pt-5" width="15%" ><button formaction="deleteFromWishList.php" type="submit" type="button" class="btn btn-outline-danger">Delete</button> </td>
                            </tr>
                          </form>
                    <?php 
                        }
